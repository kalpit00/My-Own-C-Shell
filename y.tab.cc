...
{
       0,    57,    57,    61,    62,    65,    69,    73,    74,    78,
      85,    86,    90,   106,   114,   115,   119,   124,   128,   133,
     138,   144,   151,   152,   155,   158
};
#endif
...
static const char *const yytname[] =
{
  ...
  "GREATAMPERSAND", "INTEGERGREAT", "$accept", "goal", "commands",
